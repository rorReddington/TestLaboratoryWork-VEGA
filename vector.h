...
void appendArray(Vector *v, int *array, size_t count); // добавляет count чисел из array в конец массива
...
int indexOf(Vector *v, int value); // возвращает индекс первого элемента со значением value
...
void clear(Vector *v); // очищает вектор
